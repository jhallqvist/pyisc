...
new_node.children.append(pyisc.dhcpd.PropertyNode(
    'match',
...
new_node = (pyisc.dhcpd.nodes.PropertyNode(
    'subclass',
    '"allocation-class-1"',
    '1:8:0:2b:4c:39:ad'))
expected_dhcpd.children.append(new_node)
...
new_node = (pyisc.dhcpd.nodes.Node(
    'subnet',
    '10.0.0.0',
    'netmask 255.255.255.0'))
child_node = (pyisc.dhcpd.nodes.Node('pool', None, None))
child_node.children.append(pyisc.dhcpd.nodes.PropertyNode(
    'allow',
...
new_node = (pyisc.dhcpd.nodes.Node(
    ...
    '"allocation-class-2"',
    '1:08:00:2b:a1:11:31'))
new_node.children.append(pyisc.dhcpd.nodes.PropertyNode(
    'option root-path',
